...
def build_aaa_payload(
    ...
    payload = {
        ...
        "summary": {
            ...
            "location_accuracy": summary.get("location_accuracy", 0.0),
            "avg_total_reward": summary.get("avg_total_reward", 0.0),
            "avg_steps": summary.get("avg_steps", 0.0),
            "avg_steps_per_device": summary.get("avg_steps_per_device", 0.0),
...
def _episode_to_result(episode: EpisodeMetrics) -> Dict[str, Any]:
    ...
    result = {
        ...
        "steps": episode.steps,
        "steps_per_device": episode.steps_per_device,
        "max_score": 100.0,
