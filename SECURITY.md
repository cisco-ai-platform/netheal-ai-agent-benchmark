...
The `NetHeal` maintainers take all security issues in the project
seriously. Thank you for improving the security of `NetHeal`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`NetHeal` leverages GitHub's private vulnerability reporting.
