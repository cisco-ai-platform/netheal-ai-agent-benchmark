...
`CNTE` (Cisco Network Troubleshooting Environment) project.
...
The `CNTE` maintainers take all security issues in the project
seriously. Thank you for improving the security of `CNTE`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`CNTE` leverages GitHub's private vulnerability reporting.
